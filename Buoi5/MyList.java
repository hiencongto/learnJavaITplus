...
public class MyList {
    public static void main(String[] args) {
        ...
        // // Tree: cấu trúc dang cây, root-leaf trái-leaf phải, leaf trái nhỏ hơn root,
        // leaf phải lớn hơn root
        // // Graph: cấu trúc dạng đồ thị
        // // Map: không thuộc Collection, dạng thư viện được gắn kèm trong Java,
        // key-value

        // // List: tập hợp các phần tử sắp xếp liền kề nhau trên ô nhớ
        // // ArrayList: tồn tại giống dạng mảng, phù hợp vs các tập dữ liệu ít thêm
        // xóa, nhiều truy vấn
        // // LinkedList: tồn tại dưới dạng các Node liên kết, phù hợp vs các tập dữ
        // liệu thường xuyên thêm xóa, ít truy vấn

        // // bt: lưu trữ điểm của 1 học sinh: 6,8,4,9
        // ArrayList<Integer> integers = new ArrayList<>();
        // // ArrayList: tên của lớp tạo đối tượng
        // // <>: dấu kim cương, Generic trong java => dùng để quy định kiểu dữ liệu cho
        // List
        // // như ví dụ trên: danh sách integers chỉ được phép chứa kiểu số nguyên
        // // Integer: lớp Wrapper trong Java, đơn giản là Object hóa các dữ liệu nguyên
        // thủy để sử dụng 1 số phương thức đặc biệt
        // // Tất cả các Collection + Map không sử dụng giá trị thuộc KDL nguyên thủy

        // // Collection sẽ cung cấp rất nhiều các phương thức để hỗ trợ cho lập trình
        // viên sử dụng
